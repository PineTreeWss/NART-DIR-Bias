...
# Modified by NLP2CT Lab @SongSheng Wang
# Objective: obtain the padding index positions, supporting the padding index mask and initialization of the Reverce Link.
...
@register_task("translation_bi_dag", dataclass=TranslationLevenshteinConfig)
class TranslationBiDagTask(TranslationTask):
    """
    ...
    def train_step(
        ...
        ispad_mask = sample['target'].eq(self.tgt_dict.pad())
        if ignore_grad:
            sample['dummy'] = True

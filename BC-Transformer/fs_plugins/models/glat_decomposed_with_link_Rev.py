...
@register_model("glat_decomposed_link_Rev")
class GlatDecomposedLink(FairseqNATModel):
    ...
    def extract_valid_links(self, content, valid_mask):
        ...
        invalid_idx_mask = valid_links_idx < prelen-valid_mask.sum(dim=-1, keepdim=True).unsqueeze(-1)
...
@register_model_architecture(
    "glat_decomposed_link_Rev", "glat_decomposed_link_rev_6e6d512"
)
...
@register_model_architecture(
    "glat_decomposed_link_Rev", "glat_decomposed_link_base_rev"
)
